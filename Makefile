...
$(BUILD_DIR)/dirdoc_test: $(filter-out $(BUILD_DIR)/dirdoc.o, $(OBJECTS)) $(BUILD_DIR)/dirdoc_test.o $(MAIN_CPP_OBJECTS) $(filter-out $(BUILD_DIR)/test_test_file_deletion.o, $(TEST_OBJECTS)) $(TIKTOKEN_GENERATED_HEADER) | deps
